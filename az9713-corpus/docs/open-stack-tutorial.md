...
![Open Stack infographic](open_stack_infographic_explained_v2.png)
...
- `open_stack_infographic_explained_v2.png` - visual overview of the Open Stack workflow.
