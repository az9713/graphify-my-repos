---
repo: claude-runs-opencode
description: One prompt. Four LLMs. One comparison video. Claude Code orchestrates OpenCode to benchmark models in parallel via OpenRouter, then renders a 2x2 grid video with Remotion.
language: TypeScript
stars: 0
forks: 0
created: 2026-02-16
