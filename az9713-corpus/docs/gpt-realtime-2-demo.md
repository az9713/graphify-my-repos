---
repo: gpt-realtime-2-demo
description: Voice Operations Cockpit — self-hostable voice agent platform on top of OpenAI gpt-realtime-2 + Twilio Media Streams. Hybrid Python/Node, one agent core, browser + phone surfaces, full guardrails + approvals + observability.
language: Python
stars: 1
forks: 0
created: 2026-05-08
