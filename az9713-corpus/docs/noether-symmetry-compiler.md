---
repo: noether-symmetry-compiler
description: Where compiler theory meets classical mechanics. Treats a Lagrangian as source code, runs compiler-style passes to detect symmetries, and derives conservation laws automatically via Noether's theorem.
language: Python
stars: 0
forks: 0
created: 2026-03-07
