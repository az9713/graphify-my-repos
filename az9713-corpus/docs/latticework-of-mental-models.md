---
repo: latticework-of-mental-models
description: 84-page PDF guide on Charlie Munger's latticework of mental models — 150+ models across 6 disciplines, the Lollapalooza Effect, and Mohnish Pabrai's practical extensions. Includes a Python PDF generator and 8-section article written by a multi-agent AI team.
language: Python
stars: 1
forks: 0
created: 2026-03-26
