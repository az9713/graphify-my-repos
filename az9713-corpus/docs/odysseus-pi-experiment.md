---
repo: odysseus-pi-experiment
description: Experiment: embedding pi (a minimal terminal coding agent) as a long-horizon, memory-aware agent backend inside Odysseus. Fork of pewdiepie-archdaemon/odysseus + integration under integrations/pi/. See docs/odysseus-pi-journey.md.
language: Python
stars: 2
forks: 0
created: 2026-06-09
