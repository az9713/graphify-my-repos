---
repo: merch-store-stripe-cli
description: Production-grade Next.js print-on-demand storefront (Supabase, Stripe, Printify). Fully functioning with 182 tests. Security-audited — 13 findings, full report in SECURITY_AUDIT.md.
language: TypeScript
stars: 0
forks: 0
created: 2026-03-24
