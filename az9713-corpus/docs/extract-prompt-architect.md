---
repo: extract-prompt-architect
description: The extraction-prompt-architect Claude Code skill — distilling a minimal set of maximal-signal prompts to mine dense sources — plus its development journey and a worked example on a SemiAnalysis grid/datacenter note.
language: None
stars: 0
forks: 0
created: 2026-06-26
