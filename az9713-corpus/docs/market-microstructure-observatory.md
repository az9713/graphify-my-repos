---
repo: market-microstructure-observatory
description: Limit-order-book simulator validated against real-market stylized facts, an honest real-data backtester (no lookahead, latency, fees, queue modelling), and a WebGL observatory. Zero dependencies.
language: JavaScript
stars: 0
forks: 0
created: 2026-08-02
updated: 2026-08-02
topics: agent-based-model, backtesting, limit-order-book, market-microstructure, quantitative-finance, webgl
is_fork: False
kb: 708
---
