---
repo: claude-design-sync
description: Round-trip: build a design system as code, /design-sync into Claude Design, design a World Cup 2026 deck on it, then export back to runnable code.
language: TypeScript
stars: 0
forks: 0
created: 2026-06-25
