---
repo: day-trading-toolkit
description: Five ready-to-use day trading tools: ORB alerts (Pine Script + ThinkScript), pre-market game plan template, trade journal analyzer (Python), 2-bar trailing stop, and AI trade autopsy template. Built from SMB Training workflows.
language: None
stars: 0
forks: 0
created: 2026-05-27
