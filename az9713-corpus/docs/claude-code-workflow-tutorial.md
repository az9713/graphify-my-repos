---
repo: claude-code-workflow-tutorial
description: Claude Code orchestration primitives: interactive HTML tutorial + Hyperframes video. Built with @claude-code-guide, Tailwind CDN, GSAP, and the Hyperframes CLI.
language: HTML
stars: 1
forks: 0
created: 2026-06-02
