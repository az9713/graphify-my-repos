---
repo: mirage-tutorial
description: Fork of strukto-ai/mirage with comprehensive documentation demystifying the filesystem abstraction for AI agents.
language: TypeScript
stars: 0
forks: 1
created: 2026-05-28
...
> ### 📚 This is a fork of [`strukto-ai/mirage`](https://github.com/strukto-ai/mirage), enhanced with comprehensive documentation.
>
> The original MIRAGE source is **unmodified**. This fork adds a complete, from-first-principles documentation set under [**`docs/`**](./docs) that demystifies MIRAGE's core abstraction — *how heterogeneous services (Gmail, Slack, S3, GitHub, Postgres, …) become one filesystem an AI agent can navigate with plain bash*.
>
> **Start here:**
> - 🗺️ [`docs/index.md`](./docs/index.md) — navigation hub
> - 🎯 [`docs/concepts/the-filesystem-abstraction.md`](./docs/concepts/the-filesystem-abstraction.md) — the central concept, explained from zero
> - 🚀 [`docs/getting-started/onboarding.md`](./docs/getting-started/onboarding.md) — narrative walkthrough for newcomers
> - 🔬 [`docs/architecture/system-design.md`](./docs/architecture/system-design.md) — end-to-end trace of one `ws.execute()` call
