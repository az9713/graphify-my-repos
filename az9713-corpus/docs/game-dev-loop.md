---
repo: game-dev-loop
description: An autonomous game-development loop for Claude Code: from a one-paragraph brief, the agent loops brainstorm->plan->build->review->improve unattended until exit conditions are met. Demo builds a procedurally-generated text kingdom game.
language: HTML
stars: 0
forks: 0
created: 2026-06-18
