---
repo: niche-directory-builder
description: Build niche online directories with Python data pipeline (Outscraper + Crawl4AI + Claude API) and Next.js frontend. Runs on 100 mock listings out of the box — no database needed. Inspired by Frey Chu's methodology from the Greg Isenberg podcast.
language: TypeScript
stars: 1
forks: 0
created: 2026-02-17
