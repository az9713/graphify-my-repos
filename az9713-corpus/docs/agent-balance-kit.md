---
repo: agent-balance-kit
description: A Windows-first Claude Code harness that treats human attention as the bottleneck: queue-only agent dispatch, health-gated scope, evidence-based completion.
language: Python
stars: 0
forks: 0
created: 2026-06-17
