---
repo: autoresearch-llm-molecule-bench
description: Karpathy's autoresearch loop applied to LLM molecule benchmark — prompt engineering the Kulik Challenge
language: Python
stars: 0
forks: 0
created: 2026-03-25
...
# autoresearch-llm-molecule-bench
