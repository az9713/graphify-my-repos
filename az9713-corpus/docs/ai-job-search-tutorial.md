---
repo: ai-job-search-tutorial
description: Clone of MadsLorentzen/ai-job-search enhanced with deep-dive documentation for onboarding and development
language: TypeScript
stars: 0
forks: 0
created: 2026-06-06
...
> [!NOTE]
> **This repository is a clone of [MadsLorentzen/ai-job-search](https://github.com/MadsLorentzen/ai-job-search), enhanced with deep-dive documentation for onboarding and development.** Start at **[docs/index.md](docs/index.md)** — it demystifies how the framework works inside and teaches you how to build projects like it.
