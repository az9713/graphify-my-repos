---
repo: paseo-tutorial
description: A clone of getpaseo/paseo enhanced with a beginner-friendly deep-dive documentation set (docs/understanding-paseo/). Documentation only; all code credit to upstream (AGPL-3.0).
language: TypeScript
stars: 0
forks: 0
created: 2026-06-08
