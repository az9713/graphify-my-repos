---
repo: clawpatch-tutorial
description: Tutorial clone of openclaw/clawpatch — enhanced with deep-dive internal documentation and a hands-on testing journal
language: TypeScript
stars: 0
forks: 0
created: 2026-05-19
...
> **Tutorial clone of [openclaw/clawpatch](https://github.com/openclaw/clawpatch/) — enhanced with deep-dive internal documentation and a hands-on testing journal.**
>
> | Doc | What's inside |
> |-----|--------------|
> | [How it works](internal_docs/how-it-works.md) | Full architecture: mapping phases, review pipeline, fix flow, state machine |
> | [Prompt design](internal_docs/prompt-design.md) | The secret sauce — how every AI prompt is built and why it produces accurate findings |
> | [Testing journal](internal_docs/testing-journal.md) | Running clawpatch on `pi-main` and on itself — all runs, errors, and findings documented |
>
> See also: [I Tried NEW Clawpatch for Codex: "Optimized" Code Review](https://www.youtube.com/watch?v=MRSHPXbxd1g) — another hands-on clawpatch demo by AI Coding Daily.
