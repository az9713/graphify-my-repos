...
description: Local clone of addyosmani/agent-skills with additional documentation
language: Shell
stars: 34
forks: 4
created: 2026-04-09
...
> **This is a local clone of [github.com/addyosmani/agent-skills](https://github.com/addyosmani/agent-skills).** For the original source, issues, and contributions, visit the upstream repository.
>
> **Demo:** Watch [Google's 7-Step Vibe Engineering Skill Is Incredible](https://www.youtube.com/watch?v=4bfKyZ7hbsU&t=22s) on YouTube for a walkthrough of these skills in action.
