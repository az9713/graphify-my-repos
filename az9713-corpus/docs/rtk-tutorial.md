---
repo: rtk-tutorial
description: Educational clone of rtk-ai/rtk — tutorial docs and concept guides for learning how RTK works
language: Rust
stars: 0
forks: 0
created: 2026-05-31
...
# rtk-tutorial
> **Tutorial Clone** — This repository is an educational clone of [rtk-ai/rtk](https://github.com/rtk-ai/rtk), created for learning purposes. It adds [concept documentation](docs/concepts/) that demystifies how RTK works internally. For production use, see the [original project](https://github.com/rtk-ai/rtk).
