---
repo: claude-code-wsl-installation
description: Troubleshooting guide for installing Claude Code on WSL2 — workaround for the Hyper-V virtual network adapter bug that breaks curl/OpenSSL large transfers
language: None
stars: 0
forks: 0
created: 2026-02-21
