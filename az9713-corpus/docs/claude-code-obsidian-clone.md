---
repo: claude-code-obsidian-clone
description: Nexus Notes — an Obsidian-inspired desktop note app built entirely with Claude Code. Electron + React + CodeMirror 6.
language: TypeScript
stars: 0
forks: 0
created: 2026-03-11
