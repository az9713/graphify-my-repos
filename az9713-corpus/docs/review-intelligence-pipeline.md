---
repo: review-intelligence-pipeline
description: Turns scattered Google Maps and Yelp reviews into an evidence-based dashboard of themes, trends, and ranked actions
language: HTML
stars: 0
forks: 0
created: 2026-07-18
...
- ✅ **XSS fix found and fixed** (2026-07-17, post-push): an automated background security review caught a script-tag-breakout vulnerability in `render()` within the same session as the push. Fu