---
repo: claude-managed-agents
description: Comprehensive onboarding guide for Claude Managed Agents — featuring introductory docs, quick-start examples, and step-by-step tutorials. Based on official Anthropic docs: platform.claude.com/docs/en/managed-agents/overview | agent-sdk/quickstart | agent-sdk/python | agent-sdk/agent-loop
language: Shell
stars: 3
forks: 2
created: 2026-04-09
