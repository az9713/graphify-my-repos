---
repo: agent_scripts_tutorial
description: Clone of steipete/agent-scripts enhanced with a deep-dive documentation set (docs/). Original by Peter Steinberger (MIT).
language: Shell
stars: 0
forks: 0
created: 2026-06-13
...
> **About this fork.** This is a clone of [`steipete/agent-scripts`](https://github.com/steipete/agent-scripts) by Peter Steinberger (MIT-licensed), enhanced with a comprehensive deep-dive documentation set under [`docs/`](docs/index.md). The upstream code, skills, and rules are unchanged; the addition is a full set of onboarding, concept, reference, architecture (ADR), and troubleshooting docs that explain how the repo works end to end. Start at [`docs/index.md`](docs/index.md) or the [onboarding guide](docs/getting-started/onboarding.md). All credit for the original work belongs to the upstream author.
