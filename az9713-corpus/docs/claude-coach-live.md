---
repo: claude-coach-live
description: A self-extending habit coach for Claude Code: zero-token hooks enforce known habits, a weekly LLM loop discovers new ones
language: Python
stars: 0
forks: 0
created: 2026-07-22
