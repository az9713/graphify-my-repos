---
repo: larql-mechanism-tutorial
description: A documentation deep dive connecting larql (the product: a transformer as a queryable vindex) and the-mechanism (the proof: transformers store facts as addressable key->value slots). Bundles both with a minimal, high-signal docs suite.
language: Rust
stars: 0
forks: 0
created: 2026-06-12
