---
repo: my-cerebras-brain
description: A Cerebras-style personal knowledge base: one Postgres table, hybrid RRF retrieval, free local embeddings, Claude Code skills - built largely autonomously by an AI agent. Full dev journey in docs/.
language: Python
stars: 0
forks: 0
created: 2026-07-21
