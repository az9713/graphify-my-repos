---
repo: printing-press-wiki-cli
description: Wikipedia CLI — search, summary, random, on-this-day, article — structured JSON output, agent-native, local SQLite cache
language: Go
stars: 0
forks: 0
created: 2026-05-11
