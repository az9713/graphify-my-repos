---
repo: worldmonitor-tutorial
description: Learning fork of koala73/worldmonitor — enhanced with deepdive docs for onboarding, architecture analysis, and a breakdown of what made it go viral.
language: TypeScript
stars: 0
forks: 0
created: 2026-04-13
...
# worldmonitor-tutorial
# World Monitor

> **This is a learning fork of [koala73/worldmonitor](https://github.com/koala73/worldmonitor).**
> The original project is an open-source real-time global intelligence dashboard by [@koala73](https://github.com/koala73) (Elie Habib).
> This fork adds a [`docs/deepdive/`](./docs/deepdive/) documentation layer — structured onboarding, concept deep-dives, architecture ADRs, and an analysis of [what made it go viral](./docs/deepdive/why-it-went-viral.md) — for anyone who wants to study and learn from the codebase.
> All application code is unchanged and belongs to the original author.
