---
repo: mistral-vibe-tutorial
description: Tutorial fork of mistralai/mistral-vibe with a deep-dive learning guide (docs_deepdive/) for engineers studying how to build a minimal CLI coding agent.
language: Python
stars: 0
forks: 0
created: 2026-05-29
...
- Regex patterns are matched against the ful