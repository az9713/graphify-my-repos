---
repo: polyglot-crap
description: CRAP (Change Risk Anti-Patterns) metric for any programming language — Python, JavaScript, TypeScript, Java, Go, C, C++, C#, Ruby, Rust, PHP
language: Rust
stars: 2
forks: 0
created: 2026-05-23
...
- `path_set_matches_suffix` correctly matches relative pattern