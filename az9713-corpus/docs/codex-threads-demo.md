---
repo: codex-threads-demo
description: Demo of Codex director threads and parallel worktrees
language: JavaScript
stars: 0
forks: 0
created: 2026-06-01
...
This copy of the codebase is not about GoalBuddy as a product. It is used as a testbed for Codex threads: a director thread finds narrow bugs, creates task threads, and gives each task its own worktree for parallel work.

The demo follows the Codex thread workflow introduced in [Guinness Chen's X post](https://x.com/guinnesschen/status/2060464235868836235): "If you ever get tired of managing your Codex threads, just let Codex manage itself! Codex can now create threads, search them, organize them, pin the important ones, and spin up worktrees for parallel tasks."

See [codex-threads-demo.md](codex-threads-demo.md) for the worked example.

## Original GoalBuddy Codebase
