---
repo: particle-river
description: Scroll-driven particle-river essay: one 2D canvas, ~10k dots, curl-noise water that dodges text and fills the title. Inspired by Every's 'Before the Deluge'. Type "tune" on the page for the hidden knob panel.
language: JavaScript
stars: 0
forks: 0
created: 2026-07-28
