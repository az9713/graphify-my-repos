---
repo: aisuite-tutorial
description: Enhanced tutorial clone of andrewyng/aisuite — adds a full docs/ deep-dive and onboarding set
language: Python
stars: 0
forks: 0
created: 2026-06-12
...
# aisuite-tutorial
> ## 📚 This is an enhanced tutorial clone
>
> This repository is a clone of [**andrewyng/aisuite**](https://github.com/andrewyng/aisuite), enhanced with a
> comprehensive, production-quality documentation set for learning the codebase from scratch. The original code is
> unchanged; the addition is a full **[`docs/`](docs/index.md)** tree:
>
> - **[Onboarding](docs/getting-started/onboarding.md)** — a zero-to-hero conceptual walkthrough for newcomers.
> - **[Concept deep dives](docs/concepts/)** — how each subsystem actually works (chat completions, providers, tool
>   calling, the Agents API, toolkits, policies, state, MCP, tracing).
> - **[Guides](docs/guides/)** — task-oriented how-tos.
> - **[Reference](docs/reference/)** — complete API, provider, and configuration reference.
> - **[Architecture & ADRs](docs/architecture/system-design.md)** — system design and the decisions behind it.
>
> **→ Start at [`docs/index.md`](docs/index.md).** For everything below this box, see the upstream project.
...
> real run in [`example-session.txt`](projects/research-desk/example-session.txt). Deep dives:
> [`ORCHESTRATION.md`](projects/research-desk/ORCHESTRATION.md) (how the team is coordinated and
> how to read the traces) and [`PERSISTENCE.md`](projects/research-desk/PERSISTENCE.md) (how
