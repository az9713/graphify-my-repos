---
repo: bash-security-levels-tutorial
description: Clone of disler/bash-damage-from-within — 5 levels of agent bash security, with detailed EXPLAINER.md
language: Python
stars: 0
forks: 0
created: 2026-05-12
...
# bash-security-levels-tutorial
> **This is a clone of [disler/bash-damage-from-within](https://github.com/disler/bash-damage-from-within), enhanced with a detailed [`EXPLAINER.md`](docs/EXPLAINER.md) that walks through all five agent security levels — what each level protects, where it fails, and why the next level exists.**
