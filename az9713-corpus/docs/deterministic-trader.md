---
repo: deterministic-trader
description: Deterministic trading system: macro gate + quantitative scanner (Layers 1 & 2 from the Claude trading architecture). 8-factor stock ranking, walk-forward validation, Monte Carlo, risk layer.
language: Python
stars: 0
forks: 0
created: 2026-05-18
