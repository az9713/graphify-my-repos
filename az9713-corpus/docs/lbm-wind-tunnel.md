---
repo: lbm-wind-tunnel
description: A validated lattice-Boltzmann wind tunnel: why the second race car catches the first, and why geese fly in a V. Built and checked in 14h41m — live browser sim + journey. MVP (Race + Theater) also showcases Buzz as a human-agent workspace.
language: HTML
stars: 0
forks: 0
created: 2026-07-30
