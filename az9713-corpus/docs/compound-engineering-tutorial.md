---
repo: compound-engineering-tutorial
description: Documented fork of EveryInc/compound-engineering-plugin — comprehensive docs: architecture, CLI reference, workflow examples, and troubleshooting
language: None
stars: 0
forks: 0
created: 2026-04-16
...
# compound-engineering-tutorial
# Compound Engineering

> **This is a documented fork of [EveryInc/compound-engineering-plugin](https://github.com/EveryInc/compound-engineering-plugin).**
> The plugin code and skills are unchanged. This fork adds a comprehensive documentation layer written from scratch — architecture overview, concept guides, CLI reference, workflow examples, and troubleshooting — to make the plugin easier to understand and use.
>
> **New to compound engineering?** Watch [This AI Coding Tool That Shouldn't Be Free](https://www.youtube.com/watch?v=PMm_vRk7vfQ&t=23s) for a quick intro, then start with the docs below.
...
|---------|--------------|
| [Overview](docs/overview/what-is-this.md) | Mental model, philosophy, architecture |
| [Key concepts](docs/overview/key-concepts.md) | Glossary: plugin, skill, agent, target, sync |
| [Quickstart](docs/getting-started/quickstart.md) | Install and run your first command in under 10 minutes |
| [Onboarding](docs/getting-started/onboarding.md) | Zero-to-hero guide for newcomers |
| [Concepts: plugin](docs/concepts/plugin.md) | How the compound-engineering plugin works |
| [Concepts: CLI](docs/concepts/cli.md) | The converter and installer CLI |
| [Concepts: converter pipeline](docs/concepts/converter-pipeline.md) | How Claude Code plugins become other formats |
| [Commands](docs/commands/overview.md) | CLI command reference (install, convert, sync, plugin-path) |
| [Workflow examples](docs/guides/workflows.md) | 8 copy-pasteable workflows: full cycle, review with plan verification, ideate, debug, and more |
| [Guides](docs/guides/local-development.md) | How-tos for contributors and advanced users |
| [Target reference](docs/reference/targets.md) | All supported targets, output paths, scope options |
| [Architecture](docs/architecture/system-design.md) | System design, data flows, key decisions |
| [Troubleshooting](docs/troubleshooting/common-issues.md) | Top install, sync, and convert failures |
...
├── overview/
│   ├── what-is-this.md               mental model and architecture
│   └── key-concepts.md               glossary of every important term
├── getting-started/
│   ├── quickstart.md                 install + first command in < 10 min
│   └── onboarding.md                 zero-to-hero for newcomers
├── concepts/
│   ├── plugin.md                     skills, agents, and the workflow cycle
│   ├── cli.md                        converter and installer CLI deep dive
│   └── converter-pipeline.md         how Claude → target conversion works
├── commands/
│   ├── overview.md                   command summary table
│   ├── install.md                    install flags, examples, exit codes
│   ├── convert.md                    convert flags and examples
│   ├── sync.md                       sync flags, per-target behavior
│   ├── plugin-path.md                branch testing and shell aliases
│   └── list.md                       list bundled plugins
├── guides/
│   ├── workflows.md                  8 copy-pasteable real-world workflows
│   ├── add-a-target-provider.md      checklist for adding a new converter target
│   └── local-development.md          dev setup, aliases, test commands
├── reference/
│   └── targets.md                    all 10 targets with output paths and notes
├── architecture/
│   └── system-design.md              components, data flows, key decisions
└── troubleshooting/
    └── common-issues.md              top install/sync/convert failures + fixes
```
