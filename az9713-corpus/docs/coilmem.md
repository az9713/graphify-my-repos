---
repo: coilmem
description: Shared memory for multi-agent systems: workspace shared scope + per-agent private scope, with a researcher->critic->writer team that exercises it
language: Python
stars: 0
forks: 0
created: 2026-06-22
