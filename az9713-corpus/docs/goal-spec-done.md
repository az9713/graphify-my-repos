---
repo: goal-spec-done
description: Yet another spec-driven Claude Code workflow. Based on GSD.
language: JavaScript
stars: 0
forks: 0
created: 2026-01-11
...
|----------|-------------|
| [Quick Start Guide](docs/QUICK_START.md) | Get running in 5 minutes with 10 educational examples |
...
| [Glossary & FAQ](docs/GLOSSARY.md) | Terms, common questions, and quick reference |

### For Developers

| Document | Description |
|----------|-------------|
| [Developer Guide](docs/DEVELOPER_GUIDE.md) | How GSD works internally, making changes |
| [Architecture Guide](docs/ARCHITECTURE.md) | System design, data flow, extension points |
