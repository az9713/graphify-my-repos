---
repo: huashu-design-tutorial
description: Tutorial clone of alchaincyf/huashu-design, enhanced with extensive English documentation demystifying how the skill produces high-quality design assets
language: HTML
stars: 0
forks: 0
created: 2026-04-27
...
# huashu-design-tutorial
> **This is a tutorial clone of [alchaincyf/huashu-design](https://github.com/alchaincyf/huashu-design), enhanced with two collections of deep-dive English documentation to demystify how the skill produces high-quality design assets:**
> - **[`docs/`](docs/index.md)** — 20 structured reference docs covering every subsystem (motion engine, Core Asset Protocol, Tweaks, export pipeline, all 20 design schools, and more)
> - **[`codex_doc/`](codex_doc/README.md)** — architecture deep-dives, execution playbooks, and annotated system diagrams
>
> **For a live demo and head-to-head comparison with Claude Design, watch: [This Open Source Repo Just Cloned Claude Design (It's GOOD)](https://www.youtube.com/watch?v=Nmk1wxoi6ys&t=7s)**
>
> All credit for the original skill, prompts, components, and demos goes to [Huasheng (花生)](https://www.huasheng.ai/).

<p align="center">
  <img src="codex_doc/anatomy-of-huashu-design.svg" alt="Anatomy of Huashu Design — system overview diagram" width="100%">
</p>
