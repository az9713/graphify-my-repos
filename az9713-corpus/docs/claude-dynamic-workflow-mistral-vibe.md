---
repo: claude-dynamic-workflow-mistral-vibe
description: A worked example of a Claude Code dynamic workflow: a real 19-agent type-escape sweep across the Mistral Vibe codebase, with script, design writeup, line-by-line explainer, findings, and a screen recording.
language: JavaScript
stars: 0
forks: 0
created: 2026-06-01
...
# claude-dynamic-workflow-mistral-vibe
