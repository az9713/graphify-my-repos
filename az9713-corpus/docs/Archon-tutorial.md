---
repo: Archon-tutorial
description: Fork of coleam00/Archon enhanced with an 8-chapter agentic engineering tutorial series and gap-filling reference docs
language: TypeScript
stars: 0
forks: 0
created: 2026-04-11
...
> **This is a learning-focused fork of [coleam00/Archon](https://github.com/coleam00/Archon).**
>
> It adds two things the upstream repo does not have:
>
> 1. **An 8-chapter tutorial series** (`docs/tutorials/`) — teaches the craft of building AI agent harnesses from first principles. Zero prior agentic experience required. Covers tool call loops, the harness pattern, DAG workflows, parallel agents, structured output, loops, human-in-the-loop, and production concerns. Each chapter includes a hands-on exercise.
>
> 2. **Gap-filling reference docs** (`docs/`) — covers features of Archon not documented in the main docs site:
>
>    | Doc | What it covers |
>    |-----|----------------|
>    | [`docs/reference/script-nodes.md`](docs/reference/script-nodes.md) | `script:` node type — inline TypeScript/Python without AI, `runtime:`, `deps:`, `timeout:` |
>    | [`docs/reference/claude-advanced-options.md`](docs/reference/claude-advanced-options.md) | All 10 Claude-only per-node options: `effort`, `thinking`, `maxBudgetUsd`, `sandbox`, `fallbackModel`, `betas`, `systemPrompt`, `hooks`, `mcp`, `skills` |
>    | [`docs/reference/variables.md`](docs/reference/variables.md) | Complete variable reference including `$LOOP_USER_INPUT` and `$REJECTION_REASON` with exact scoping rules |
>    | [`docs/guides/structured-output.md`](docs/guides/structured-output.md) | `output_format` + classify-then-route pattern, script nodes for complex routing logic |
>    | [`docs/guides/workflow-adversarial-dev.md`](docs/guides/workflow-adversarial-dev.md) | How `archon-adversarial-dev` works — GAN-inspired 4-phase build loop |
>    | [`docs/guides/workflow-interactive-prd.md`](docs/guides/workflow-interactive-prd.md) | How `archon-interactive-prd` works — 3-round human-in-the-loop PRD creation |
>
> **Start here:** → [`docs/tutorials/index.md`](docs/tutorials/index.md)
>
> The upstream project, full feature documentation, and setup instructions follow below.
...
### This fork's additional docs

| Doc | What it covers |
|-----|----------------|
| [Tutorial series](docs/tutorials/index.md) | 8-chapter agentic engineering course, zero prior experience required |
| [script: node reference](docs/reference/script-nodes.md) | Inline TypeScript/Python nodes without AI |
| [Claude advanced options](docs/reference/claude-advanced-options.md) | `effort`, `thinking`, `maxBudgetUsd`, `hooks`, `mcp`, `skills`, and more |
| [Variable reference](docs/reference/variables.md) | Every substitution variable with exact scoping rules |
| [Structured output & routing](docs/guides/structured-output.md) | `output_format`, classify-then-route pattern |
| [archon-adversarial-dev guide](docs/guides/workflow-adversarial-dev.md) | GAN-inspired build-from-scratch workflow |
| [archon-interactive-prd guide](docs/guides/workflow-interactive-prd.md) | Human-in-the-loop PRD creation workflow |

### Upstream documentation

Full documentation for Archon is available at **[archon.diy](https://archon.diy)**.
